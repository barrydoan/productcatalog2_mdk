...
export function imageToPath(bindingObject, keyProperty, imageGroup) {
	...
	if (!key) { //If key property has no value, let's fall back to use read link
		...
		var readLink = "https://7098580dtrial.launchpad.cfapps.us10.hana.ondemand.com/e8fe3d17-2e09-4bf7-a6b3-10e8140bcab1.productcatalog.frontend-0.0.1/img/" + bindingObject.imageUrl;
